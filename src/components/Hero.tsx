...
function Hero() {
  ...
  return (
    <div className="flex flex-col bg-black items-center justify-center w-screen h-auto lg:h-screen overflow-hidden pointer-events-none">
      <motion.div 
      variants={containerVariants}
      initial="hidden"
      animate="show"
      className="grid grid-cols-5 lg:grid-rows-5 gap-0.5 flex w-auto h-auto items-center justify-center">
          <motion.div variants={itemVariants} className="row-span-2 bg-white w-full h-10 lg:h-full"></motion.div>
          ...
          <motion.div variants={itemVariants} className="col-span-3 col-start-2 row-start-3 flex flex-col bg-white w-full h-full">
            <div className="grid grid-cols-1 grid-rows-2 flex p-10 items-center justify-center">
              ...
              <div className="w-full lg:pl-15 lg:pr-15">
          ...
          <motion.div variants={itemVariants} className="row-span-2 col-start-5 row-start-4 bg-white w-full h-10 lg:h-full"></motion.div>
      </motion.div>
    </div>
  )
}
